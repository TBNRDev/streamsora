          ...
          >
            ...
            <div className="flex items-center gap-2 lg:gap-5 font-bold font-karla text-sm lg:text-xl">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-sm lg:text-base font-medium">日数</span>
              </div>
              <span></span>
              <div className="flex flex-col items-center">
                <span className="text-action/80">{hours}</span>
                <span className="text-sm lg:text-base font-medium">営業時間</span>
              </div>
              <span></span>
              <div className="flex flex-col items-center">
                <span className="text-action/80">{minutes}</span>
                <span className="text-sm lg:text-base font-medium">分</span>
              </div>
              <span></span>
              <div className="flex flex-col items-center">
                <span className="text-action/80">{seconds}</span>
                <span className="text-sm lg:text-base font-medium">秒</span>
              </div>
            </div>
          </div>
        </div>
                        ...
                        <div className="flex items-center justify-between w-full">
                          <div className="font-karla px-2">
                            ...
                            <p className="font-semibold text-xs text-gray-400">
                              {convertUnixToTime(i.airingAt)} - エピソード{" "}
                              {i.airingEpisode}
                            </p>
                          </div>
                          <div>
