...
import { ChevronRightIcon, ChevronLeftIcon, ExclamationCircleIcon, PlayIcon } from "@heroicons/react/24/solid";
...
export default function Content({
  ...
  const slideLeft = () => {
    if (ref.current) {
      ...
      const slider = document.getElementById(ids);
  ...
  const goToPage = () => {
    const routeMap: { [key: string]: string } = {
      "Recently Watched": `/en/anime/recently-watched`,
      "New Episodes": `/en/anime/recent`,
      "Trending Now": `/en/anime/trending`,
      "Popular Anime": `/en/anime/popular`,
      "Your Plan": `/en/profile/${userName}/#planning`,
      "On-Going Anime": `/en/profile/${userName}/#current`,
      "Your Watch List": `/en/profile/${userName}/#current`,
    };
    const route = routeMap[section];
    if (route) {
      router.push(route);
    } else {
      // Handle the case where the section doesn't exist in the routeMap
      toast.error(`Route not found for section: ${section}`);
    }
  };
  ...
  return (
    <div>
      <div
        className={`flex items-center justify-between lg:justify-normal lg:gap-3 px-10 z-40 ${section === "Recommendations" ? "" : "cursor-pointer"
          }`}
        onClick={goToPage}
      >
        ...
        >
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    <div className="h-[200px] w-[135px] lg:h-[265px] lg:w-[185px] rounded z-30">
                      {ids === "recentAdded" && (
                        <div className="absolute bg-gradient-to-b from-black/30 to-transparent bg-transparent from-5% to-30% top-0 z-30 w-full h-full rounded" />
                      )}
                      {image && (
                        <Image
                          draggable={false}
                          ...
                          height={300}
                          quality={100}
                          className="z-20 h-[200px] w-[135px] lg:h-[280px] lg:w-[185px] object-cover rounded brightness-90"
                        />
                      )}
                    </div>
                    {ids === "recentAdded" && (
                      <Fragment>
                        <p className="absolute z-40 text-center w-[86px] lg:w-[110px] top-1 -left-2 lg:top-[5.5px] lg:-left-2 font-karla text-sm lg:text-base">
                          Episode{" "}
                  ...
                  {ids !== "onGoing" && (
                    <Link
                      ...
                      className="relative w-[135px] lg:w-[185px] line-clamp-2 bottom-[-5%]"
                      title={anime.title.romaji}
                    >
              ...
              .map((i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Link
                      className="relative w-[320px] aspect-video rounded overflow-hidden group"
          ...
          {userData &&
            ...
            section !== "Recommendations" && (
              <div
                ...
                onClick={goToPage}
              >
                <div className="w-[320px] aspect-video overflow-hidden object-cover rounded border-secondary border-2 flex flex-col gap-2 items-center text-center justify-center text-[#6a6a6a] hover:text-[#9f9f9f] hover:border-[#757575] transition-colors duration-200">
          ...
          {filteredData?.length >= 10 && section !== "Recommendations" && (
            <div
              ...
              onClick={goToPage}
            >
              <div className="h-[190px] w-[135px] lg:h-[265px] lg:w-[185px] object-cover rounded border-secondary border-2 flex flex-col gap-2 items-center text-center justify-center text-[#6a6a6a] hover:text-[#9f9f9f] hover:border-[#757575] transition-colors duration-200">
                <h1 className="whitespace-pre-wrap text-sm">
                  More on {section}
                </h1>
              </div>
...
function checkProgress(entry: { progress: any; media: any }) {
  ...
  if (nextAiringEpisode !== null) {
    ...
    if (episode - progress > 1) {
      ...
      return `${missedEpisodes} ${missedEpisodes === 1 ? "episode" : "episodes"
        } missed`;
    }
  }
