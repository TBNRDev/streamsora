        ...
        <footer className="flex-col w-full">
            <div
              ...
              /> */}
                    ...
                    <div
                        className="flex flex-col gap-10 lg:flex-row lg:items-end lg:gap-[9.06rem] text-[#a7a7a7] text-sm lg:text-end">
            ...
            <div className="bg-tersier border-t border-white/5">
                ...
                {" "}
                            ...
                            <span
                                className="w-6 h-6 right-[2.1rem] absolute rounded-full transform transition-transform bg-gray-200"/>
                        </label>
                    </div>
                </div>
            </div>
