...
import styles from "../en/tabs.module.css";
import { AnimatePresence, motion } from "framer-motion";

import { signOut, useSession } from "next-auth/react";
import Genres from "@/components/home/genresjp";
import Schedule from "@/components/home/schedulejp";
...
export default function Home({
    ...
    return (
        ...
        <meta
          name="description"
          content="あなたが次に夢中になるアニメやマンガを明らかにしましょう! Kaizoku は、プレミアム コンテンツの膨大な保管庫を提供し、さまざまなデバイスで簡単に利用できるため、中断のない楽しみが保証されます。今すぐ Kaizoku 体験に飛び込み、無限のエンターテイメントの世界への旅を始めましょう!"
        />
        ...
        <meta
          name="twitter:title"
          content="Kaizoku: 無料のアニメとマンガのストリーミングへの入り口"
        />
        ...
        <meta
          name="twitter:title"
          content="海賊 - 無料のアニメとマンガのストリーミング"
        />
        <meta
          name="twitter:description"
          content="次のお気に入りのアニメやマンガ シリーズを見つける旅に出かけましょう! Kaizoku は、さまざまなデバイスから簡単にアクセスできる一流のコンテンツの広範なコレクションを誇り、中断のないシームレスなストリーミング エクスペリエンスを保証します。今日から海賊の冒険を始めて、無限のエンターテイメントの世界に浸ってください!"
        />
                            ...
                            <div className="flex justify-center items-center w-full lg:w-1/2">
                                ...
                                >
                                    <Image
                                        ...
                                        alt={trendData[carouselIndex]?.title.romaji}
                                        width={500}
                                        height={500}
