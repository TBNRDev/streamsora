...
interface TrendingHentaiProps {
  sessions: any;
  trendingData: any;
  tagsData: any;
}

export default function TrendingHentai({ sessions, trendingData, tagsData }: TrendingHentaiProps) {
  ...
  const handleTagChange = async (event: React.ChangeEvent<HTMLSelectElement>) => {
