...
export default function PopularAnime({ sessions }: PopularAnimeProps) {
  ...
  return (
    <Fragment>
      <Head>
        <title>Kaizoku - Popular Anime</title>
        <meta name="title" content="Popular Anime" />
        <meta
          name="description"
          content="Explore Beloved Classics and Favorites - Dive into a curated collection of timeless anime on Kaizoku's Popular Anime Page. From iconic classics to all-time favorites, experience the stories that have captured hearts worldwide. Start streaming now and relive the magic of anime!"
        />
      </Head>
      <MobileNav hideProfile={sessions} />
